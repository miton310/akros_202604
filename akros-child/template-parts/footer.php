  ...
  <div class="l-footer__inner">
    ...
    <div class="l-footer__foot">
      <div class="l-footer__btnWrap">
        <a href="<?php echo esc_url(home_url('/')); ?>#reserve" class="c-button">WEB予約</a>
      ...
      <ul class="c-fixedButton">
        <li class="c-fixedButton__item"><a href="<?php echo esc_url(home_url('/')); ?>#reserve">予約はこちら</a></li>
        <li class="c-fixedButton__item"><a href="<?php echo esc_url(home_url('/')); ?>trial">体験レッスン</a></li>
      </ul>
      <div class="c-fixedButton--pc">
        <a href="<?php echo esc_url(home_url('/')); ?>#reserve" class="c-fixedButton--pc-link">予約はこちら</a>
      </div>
